...
public class CosineScoringIterator extends TransformIterator implements ScoreIterator {
  ...
  public CosineScoringIterator(NodeParameters np, LengthsIterator lengths, CountIterator counts) {
    super(counts);
    this.np = np;
    this.counts = counts;
